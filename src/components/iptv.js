        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 text-white text-center">
              ...
              <p className="text-blue-100">Deliver content efficiently over your existing IP infrastructure</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {applications.map((app, index) => (
              <div key={index} className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-4 text-center">{app.industry}</h3>
