    ...
    return (
        <div className="relative overflow-hidden w-full py-[4em] bg-[#ff4e00] flex justify-center items-center">
            ...
            <div className="text-center z-[1] px-4 md:px-8">
                ...
                className="mt-8 px-8 mb-[20] py-3 bg-white text-[#16213d] text-xl font-[500] rounded-2xl cursor-pointer leading-6 transition-all duration-300 hover:bg-[#16213d] hover:text-white hover:scale-105">
                    Book a Demo Today
                </button>
            </div>
            <svg 
