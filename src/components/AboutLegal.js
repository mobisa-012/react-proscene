...
const AboutLegal = () => {
    ...
    return (
        <div className="relative group pt-8 w-full h-screen bg-[#fff] flex items-center justify-center overflow-hidden">
            {/* Background Image */}
            <img
                src={lc}
                alt="Legal and Courtroom Facilities Background"
            ...
            <div className="relative z-20 w-full h-full flex flex-col justify-center px-4 sm:px-8 md:px-16 lg:px-28">
                ...
                <div className={`transform transition-all duration-500 delay-75 ease-out
                    ...
                    <p className="text-white text-lg sm:text-xl md:text-2xl lg:text-xl
                        ...
                        We deliver secure, reliable technology solutions for legal environments, 
                        ensuring confidentiality, efficient case management, and seamless 
                        communication for justice systems and legal practices.
                    </p>
                </div>
                ...
                {/* Optional: Feature highlights for Legal Sector */}
