        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-gray-50 to-orange-50 rounded-3xl p-8 hover:shadow-xl transition-shadow">
                <div className="text-5xl mb-4">{room.icon}</div>
                <h3 className="text-2xl font-bold text-[#16213d] mb-2">{room.size}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-2xl font-bold text-[#16213d] mb-4">Choose Teams If:</h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start space-x-2">
                    <span className="text-[#ff4e00] mt-1">▶</span>
                    <span className="text-gray-700">{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <div className="text-5xl mb-4">🔵</div>
              <h3 className="text-2xl font-bold text-[#16213d] mb-4">Choose Zoom If:</h3>
              <ul className="space-y-3">
                {[
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-[#ff4e00] to-[#e54600] text-white p-12 rounded-3xl">
            ...
            <p className="text-orange-100 mb-8 text-lg">
              Let us design and install certified Teams or Zoom Rooms that deliver flawless video conferencing experiences.
            </p>
            <button 
