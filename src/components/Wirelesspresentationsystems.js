...
function WirelessPresentation() {
  ...
  const brands = [
    { name: "Barco ClickShare", icon: "🔷", color: "from-[#f24b00] to-[#e54600]" },
    { name: "Crestron AirMedia", icon: "⚡", color: "from-[#f24b00] to-[#e54600]" },
    { name: "Solstice by Mersive", icon: "☀️", color: "from-[#f24b00] to-[#e54600]" },
    { name: "Kramer VIA", icon: "🎬", color: "from-[#f24b00] to-[#e54600]" }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-[#f24b00] to-[#e54600] text-white overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-40 h-40 bg-orange-400 rounded-full opacity-15 blur-3xl"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                Present Without
                <span className="block text-[#16213d]">The Cable Chaos</span>
              </h1>
              ...
              <div className="relative z-10">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl p-8">
                  ...
                  <div className="flex gap-2 mb-4">
                    <div className="flex-1 bg-[#f24b00] rounded-lg h-3"></div>
                    <div className="flex-1 bg-[#e54600] rounded-lg h-3"></div>
                    <div className="flex-1 bg-orange-400 rounded-lg h-3"></div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#16213d] mb-6">
              Why Go Wireless?
              <span className="text-[#f24b00]"> Here's Why</span>
            </h2>
      ...
      <div className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#16213d] mb-6">
              Solutions for
              <span className="text-[#f24b00]"> Every Room Size</span>
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-[#16213d]">Barco ClickShare</h4>
                ...
                <div className="flex items-start space-x-3">
                  <div className="text-2xl">⚡</div>
                  <div>
                    <h4 className="font-bold text-[#16213d]">Crestron AirMedia</h4>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-bold text-[#16213d]">Solstice by Mersive</h4>
                ...
                <div className="flex items-start space-x-3">
                  <div className="text-2xl">🎬</div>
                  <div>
                    <h4 className="font-bold text-[#16213d]">Kramer VIA</h4>
