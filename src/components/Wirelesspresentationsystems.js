...
function WirelessPresentation() {
  ...
  const brands = [
    { name: "Barco ClickShare", icon: "🔷", color: "from-[#ff4e00] to-[#e54600]" },
    { name: "Crestron AirMedia", icon: "⚡", color: "from-[#ff4e00] to-[#e54600]" },
    { name: "Solstice by Mersive", icon: "☀️", color: "from-[#ff4e00] to-[#e54600]" },
    { name: "Kramer VIA", icon: "🎬", color: "from-[#ff4e00] to-[#e54600]" }
  ];
              ...
              <div className="relative z-10">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl shadow-2xl p-8">
                  ...
                  <div className="flex gap-2 mb-4">
                    <div className="flex-1 bg-[#ff4e00] rounded-lg h-3"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#16213d] mb-6">
              Why Go Wireless?
              <span className="text-[#ff4e00]"> Here's Why</span>
            </h2>
      ...
      <div className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#16213d] mb-6">
              Solutions for
              <span className="text-[#ff4e00]"> Every Room Size</span>
            </h2>
          </div>
