...
function Casestudies() {
    return(
      ...
      {/* left side */}
        ...
        <h1 className=" font-bold text-[#f24b00] pb-6" style={{fontSize:'clamp(1.4238rem, 1.0921rem + 1.6585vw, 2.6469rem)'}}>Case Studies</h1>
  ...
  fontWeight: '600'}}>
          ...
          <div className="mt-7">
          <button className="bg-[#f24b00] text-white rounded-[15px] px-6 py-3 text-lg transition-all duration-300 hover:bg-[#16213d]">
      Book a Demo
    </button>
          </div>
        </div>
