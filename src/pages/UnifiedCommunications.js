    ...
    <div>
      ...
      <div className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#001e62] mb-3 sm:mb-4 px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <div key={index} className="bg-white p-4 sm:p-6 rounded-2xl shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
                ...
                <h3 className="font-bold text-[#001e62] mb-2 text-sm sm:text-base">{platform.name}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#001e62] mb-4 sm:mb-6">
                AV + IT Convergence
              </h2>
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-[#00abfa] rounded-full flex-shrink-0"></div>
      ...
      <div className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center flex-col space-y-3 sm:space-y-4">
            <h3 className="text-xl sm:text-2xl lg:text-3xl cardheaders font-semibold">
      ...
      <div className="bg-gradient-to-r from-[#e0f2f7] via-[#f0f9ff] to-[#e0f2f7] py-16 sm:py-20 lg:py-24 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <button 
            className="bg-blue-600 hover:bg-white hover:border-blue-600 hover:text-blue-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-full transition duration-300 w-full sm:w-auto"
            onClick={handleButtonClick}
          >
      ...
      <div id="faqs" className="flex flex-col mt-6 sm:mt-9 pt-4 sm:pt-6 justify-center items-center pb-5 px-4">
        <h3 className="text-2xl sm:text-3xl lg:text-4xl onsitesubheads font-bold mb-4 sm:mb-6 text-center">
